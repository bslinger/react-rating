/*! react-rating - 1.0.5 | (c) 2015, 2018  dreyescat | MIT | https://github.com/dreyescat/react-rating */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RatingAPILayer = (function (_React$PureComponent) {
	  ...
	  _createClass(RatingAPILayer, [{
	    ...
	    key: 'translateValueToDisplayValue',
	    value: function translateValueToDisplayValue(value) {
	      if (value === undefined) {
	        return 0;
	      }
	    ...
	    value: function render() {
	      ...
	      var passDisplayValue = _props.passDisplayValue;
	...
	RatingAPILayer.propTypes = "boolean" !== 'undefined' && (true) && {
	  ...
	  passDisplayValue: _propTypes2['default'].bool
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _iconNode = function _iconNode(icon) {
	  ...
	  if (_react2['default'].isValidElement(icon)) {
	    return _react2['default'].cloneElement(icon, extraProps);
	  }
	...
	var RatingSymbol = (function (_React$PureComponent) {
	  ...
	  _createClass(RatingSymbol, [{
	    ...
	    value: function render() {
	      ...
	      var iconNode = _iconNode(activeIcon, passDisplayValue && { displayValue: displayValue });
	...
	RatingSymbol.propTypes = "boolean" !== 'undefined' && (true) && {
	  ...
	  displayValue: _propTypes2['default'].number
	};
