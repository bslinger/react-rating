/*! react-rating - 1.0.3 | (c) 2015, 2018  dreyescat | MIT | https://github.com/dreyescat/react-rating */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Rating = (function (_React$PureComponent) {
	  ...
	  _createClass(Rating, [{
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(nextProps) {
	      var dirty = this.props.value !== nextProps.value && !this.state.dirty ? true : this.state.dirty;
	      this.setState({
	        dirty: dirty,
